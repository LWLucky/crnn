...
parser.add_argument('--trainroot', help='path to dataset',default="./data/train")
parser.add_argument('--valroot', help='path to dataset',default="./data/val")
...
parser.add_argument('--ngpu', type=int, default=10, help='number of GPUs to use')
...
def val(net, dataset, criterion, max_iter=100):
    ...
    for i in range(max_iter):
        ...
        sim_preds = converter.decode(preds.data, preds_size.data, raw=False)#decode返回的是Unicode编码格式
        #print(sim_preds)
        #print(cpu_texts)
